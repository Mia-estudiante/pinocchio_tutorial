...
urdf_model_path = model_path / "go2_description/urdf" / urdf_filename
...
# standing config
q1 = np.array([0., 0., 0.32, 0., 0., 0., 1., 0., 0.8, -1.5, 0., 0.8, -1.5, 0., 1., -1.5, 0., 1., -1.5])
